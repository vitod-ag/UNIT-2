function read() {       // Parte per prima, chiamata a riga 12
...
read();
console.log('Quando verrà stampato questo testo? Dopo tutta la funzione read? NO'); // 3
...
async function otherRead() { // Parte per seconda, chiamata a riga 22
	...
	console.log("codice eseguito all'interno di async, stampato per ultimo"); // 9
}
